              ...
              <div class="box bmh-80 box-green">
                <div class="box-group">
                  <div class="box-group-area text-left">
                    ...
                    <!-- <span style="font-size:10px;margin-bottom:2px;">This month: </span><br><span style="font-size:20px;" class="box-group-text" id="count-report">-</span><br> -->
                    ...
                    <!-- <span style="font-size:10px;margin-bottom:2px;">Today: </span><br><span style="font-size:15px;" class="box-group-text" id="count-report-t">-</span> -->
                  </div>
